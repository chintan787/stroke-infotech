    ...
    <div className=" bg-white py-28 lg:py-32">
        ...
        <div className="mx-auto flex flex-col lg:flex-row max-w-[1320px] items-center justify-between px-6 lg:px-10 gap-16">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row text-center items-center justify-center gap-10 md:gap-20 lg:gap-40 pt-28 pb-10">
                ...
                <div>
                    <h2 className=" text-7xl leading-[76px] text-primary font-bold text-center">60+</h2>
                    <p className="font-montserrat text-xl leading-7 font-semibold mt-4">Satisfied Clients</p>
                </div>
                <div>
                    <h2 className="text-7xl leading-[76px] text-primary font-bold text-center">200+</h2>
                    <p className="font-montserrat text-xl leading-7 font-semibold mt-4">Projects Delivered</p>
                </div>
                <div>
                    <h2 className="text-7xl leading-[76px] text-primary font-bold text-center">20+</h2>
                    <p className="font-montserrat text-xl leading-7 font-semibold mt-4">Expert Developers</p>
                </div>
