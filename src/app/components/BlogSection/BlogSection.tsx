                ...
                <div className='flex flex-col lg:flex-row gap-6 xl:gap-12 flex-wrap lg:flex-nowrap '>
                    ...
                    <div className='max-w-full h-full w-full bg-white rounded-[20px] shadow-md'>
                        ...
                        <div className='my-4'>
                            <div className='flex'>
                                ...
                                <p className='text-primary font-medium text-lg md:text-xl leading-5 md:leading-[1.5rem] px-4 my-2'>Dec 13 2023</p>
                            </div>
                            <div className='px-5 pt-2 pb-6 '>
                                <p className='font-secondaryFont font-medium text-lg md:text-xl leading-[1.625rem] md:leading-[1.875rem] text-black'>UX/UI best practices: Extensive interview with Fingers Media designers</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <Image src="/images/BlogSection/Blog-2.png" alt='' width={400} height={240}  className='rounded-t-[20px] h-60 w-full' />
                        <div className='my-4'>
                            ...
                            <div className='px-5 pt-2 pb-6 '>
                                <p className='font-secondaryFont font-medium text-lg md:text-xl leading-[1.625rem] md:leading-[1.875rem] text-black '>3 things to remember when you need to publish Android app on Play Store</p>
                            </div>
                        </div>
                    </div>
                    </div>
